...
if (link && link.startsWith('http://localhost:3000')) {
    // Convert the link from http://localhost:3000 to http://xss1-frontend:80 and keep the rest of the path
    const convertedLink = 'http://xss1-frontend:80' + link.slice(21);
